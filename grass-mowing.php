...
<main class="main">
    ...
    <section class="cleanup-company">
        <div class="cleanup-company__content">
            <div class="container">
                <div class="cleanup-company__inner">
                    <div class="cleanup-company__info">
                        <h2 class="cleanup-company__title title">
                            Клининг территории возле зданий от «CleanUp Company»
                        </h2>
                        <div class="cleanup-company__box cleanup-company__mobail">
                            <div class="cleanup-company__box-bg">
                                <img class="cleanup-company__images"
                                     src="<?php bloginfo('template_directory'); ?>/assets/img/cleanup-company/1.jpg"
                                     alt="alt">
                            </div>
                        </div>
                        <p>
                            Нужно следить за порядком в урнах на улице? Необходимо подстричь ветки у кустов? Привести
    ...
    <section class="order-summer">
        <div class="order-summer__content">
            <div class="container">
                <h2 class="order-summer__title title">
                    Что вы получаете при заказе летней уборки?
                </h2>
                <div class="order-summer__redactor">
                    <p>
                        Уборка в летнее время включает в себя ряд важных моментов, о которых мы расскажем ниже:
                    </p>
                </div>
                <div class="order-summer__slider">
                    <div class="swiper-wrapper">
                        <div class="order-summer__slide swiper-slide">
                            <h3 class="order-summer__subtitle">
                                <span class="order-summer__number">1.</span> Уборка тротуаров
                            </h3>
                            <p class="order-summer__text">
                                На небольших территориях работы выполняются вручную, при необходимости привлекается техника.
                            </p>
                        </div>
                        <div class="order-summer__slide swiper-slide">
                            <h3 class="order-summer__subtitle">
                                <span class="order-summer__number">2.</span> Уборка листвы, веток и другого мусора
                            </h3>
                            <p class="order-summer__text">
                                С помощью граблей и специальных мётел уборка листвы и другого мусора с газонов.
                            </p>
                        </div>
                        <div class="order-summer__slide swiper-slide">
                            <h3 class="order-summer__subtitle">
                                <span class="order-summer__number">3.</span> Обработка газона
                            </h3>
                            <p class="order-summer__text">
                                Стрижка газонов с помощью специальной техники, при необходимости.
                            </p>
                        </div>
                        <div class="order-summer__slide swiper-slide">
                            <h3 class="order-summer__subtitle">
                                <span class="order-summer__number">4.</span> Обработка деревьев
                            </h3>
                            <p class="order-summer__text">
                                Сезонная стрижка деревьев и обработка сухих веток выполняются вручную.
                            </p>
                        </div>
                    </div>
                    <div class="order-summer__navigation projects-navigation-css">
                        <div class="order-summer__prev projects-prev-css"></div>
                        <div class="order-summer__next projects-next-css"></div>
                    </div>
                    <div class="order-summer__progressbar price-progressbar"></div>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="container">
                <div class="price__inner">
                    ...
                    <div class="price-territory__column">
                        <p class="price__text">
                            Цены в прайс-листе не являются публичной офертой. Точная стоимость услуг рассчитывается для
    ...
    <section class="grass-mowing">
        <div class="grass-mowing__content">
            <div class="container">
                <h2 class="grass-mowing__title">
                    Используем технику в зависимости от площади участка, его местонахождения и состояния: триммеры, колесные и роторные газонокосилки, трактора.
                </h2>
                <div class="grass-mowing__redactor">
                  <p>
                    Выполняем работы на объектах с любым рельефом:
                  </p>
                </div>
                <div class="grass-mowing__items">
                    <div class="grass-mowing__item">
                        <div class="grass-mowing__box">
                            <img class="grass-mowing__img" src="<?php bloginfo('template_url'); ?>/assets/img/grass-mowing/1.jpg" alt="alt">
                        </div>
                         <h3 class="grass-mowing__subtitle">
                             Заболоченных
                         </h3>
                    </div>
                    <div class="grass-mowing__item">
                    ...
                    <div class="grass-mowing__item">
                        ...
                        <h3 class="grass-mowing__subtitle">
                            С большим количеством декоративных элементов;
                        </h3>
                    </div>
                    <div class="grass-mowing__item">
                        <div class="grass-mowing__box">
                    ...
                    <div class="grass-mowing__item">
                        ...
                        <h3 class="grass-mowing__subtitle">
                            Давно не обрабатывавшихся и заросших бурьяном
                        </h3>
                    </div>
                </div>
            </div>
