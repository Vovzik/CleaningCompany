<?php
//Template Name: Уборка магазинов и бутиков
?>
...
<main class="main">
    ...
    <section class="guarantee-purity">
        <div class="guarantee-purity__content">
            <div class="container">
                <h2 class="guarantee-purity__title">Гарантия чистоты</h2>
                <p class="guarantee-purity__text">
                    Каждому клиенту
                </p>
               <div class="tabs-items">
                   <div class="guarantee-purity__items">
                       <div class="tabs-item guarantee-purity__item active">
                           Генеральная уборка
                       </div>
                       <div class="tabs-item guarantee-purity__item">
                           После ремонта
                       </div>
                       <div class="tabs-item guarantee-purity__item">
                           Ежедневная уборка
                   ...
                   <div class="tabs-body guarantee-purity__tabs-body open">
                       <div class="guarantee-purity__body">
                           <h3 class="guarantee-purity__subtitle">
                               Чистый магазин от 50 р\м²
                           </h3>
                           <p class="guarantee-purity__subtext">
                               Безупречная уборка вашего магазина даже в самых труднодоступных местах. Вымоем все поверхности, продезинфицируем сантехнику, наполируем витрины, обеспылим и очистим осветительные приборы. Более 150 услуг на выбор. Заключаем договор, принимаем безналичный расчёт.
                           </p>
                       </div>
                   </div>
                   <div class="tabs-body guarantee-purity__tabs-body">
                       <div class="guarantee-purity__body">
                           <h3 class="guarantee-purity__subtitle">
                               Чистый магазин от 50 р\м²
                           </h3>
