<?php
//Template Name: Мойка витринных окон альпинистами
?>
...
<main class="main">
    ...
    <section class="resources">
        <div class="resources__content" style="background-image: url('<?php bloginfo('template_url'); ?>/assets/img/resources/1.jpg')">
            <div class="container">
               <div class="resources__inner">
                   <h2 class="resources__title">
                       Используем средствас антистатическим эффектом
                   </h2>
                   <p>
                       Используем в работе специальный состав, обладающий антистатическими свойствами от мирового лидера "Unger". Компоненты, входящие в состав средства, придают выраженный блеск стеклянным и зеркальным поверхностям, существенно снижают количество оседающей пыли, а капли дождя не задерживаются на стекле и просто стекают вниз. Эффект длится 1-2 недели.
                   </p>
                   <p>
                       Без разводов. Экологически безопасно.
                   </p>
               </div>
            </div>
        </div>
