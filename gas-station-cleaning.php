...
<main class="main">
    ...
    <section class="types-cleaning-business cleaning-bank">
    ...
    <div class="gas-station-cleaning">
        <div class="gas-station-cleaning__content">
            <div class="container">
                <div class="gas-station-cleaning__inner">
                    Персонал «CleanUp Company» проходит специальное обучение. Соблюдение техники безопасности на объектах с высокой пожароопасностью, проведение инструктажа, наличие наряда-допуска от клиента на заказанные услуги и присутствие менеджера АЗС — обязательное условие нашей работы на подобных объектах.
                </div>
            </div>
        </div>
    </div>
    <section class="petrol-station">
        <div class="petrol-station__content">
            <div class="container">
                <h2 class="petrol-station__title title">
                    Особенности АЗС требуют специфических приемов и методов оказания клининговых услуг:
                </h2>
                <p class="petrol-station__text">
                    На АЗС много металлических поверхностей и стойких загрязнений. Для ухода за ними мы используем профессиональные моющие средства для таких типов поверхностей. Стандартная последовательность наших работ на АЗС— мойка козырьков, крыш, отбойников, ТРК, офиса, магазина, туалета, вывески;
                </p>
                <p class="petrol-station__text">
                    Уборка АЗС осуществляется без приостановки ее работы. Это требует от персонала слаженности и высокого профессионализма. Им приходится мобильно реагировать на ситуации на АЗС, мириться с нехваткой воды, выполнять физически очень тяжелые работы по мойке подвесных потолков. На уборку АЗС площадью 400 кв. м бригада из 2 человек тратит от 8 до 10 часов. За рубежом, например, владельцы АЗС все чаще предпочитают вызывать мобильные бригады из 5-6 человек, которые за 2 часа убирают территорию в 1000 кв. м;
                </p>
                <p class="petrol-station__text">
                    Наши специалисты на объект приезжают с полным комплектом оборудования (лестницы-стремянки, штанги телескопические, вышки ТУРА, сгоны, скребки, микрофибру) и профессиональных безщелочных моющих средств;
                </p>
                <p class="petrol-station__text">
                    Уборка АЗС персоналом «Мактейлор» осуществляется без помощи операторов заправки;
                </p>
                <p class="petrol-station__text">
                    Стоимость уборки в расчете на 1 кв. м площади составляет от 40 до 110 руб. в зависимости от сложности работ и видов загрязнений.
                </p>
            </div>
        </div>
    </section>
