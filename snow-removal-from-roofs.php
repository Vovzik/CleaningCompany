<?php
//Template Name: Уборка снега с крыш
?>
...
<main class="main">
    ...
    <section class="order-summer order-summer-snow">
        <div class="order-summer__content">
            <div class="container">
                ...
                <div class="order-summer-snow__slider">
                    <div class="swiper-wrapper order-summer-snow__items">
    ...
    <section class="graphics graphics-cleaning">
                    ...
                    <div class="swiper-wrapper graphics__items">
                        <div class="swiper-slide graphics__item">
                            ...
                            <div class="graphics__item-box">
                                <h3 class="graphics-cleaning__title">
