<?php
//Template Name: Генеральная уборка
?>
...
<main class="main">
    ...
    <section class="spring-cleaning">
        <div class="spring-cleaning__content" style="background-image: url('<?php bloginfo('template_url'); ?>/assets/img/spring-cleaning/1.jpg')">
            <div class="container spring-cleaning__container">
                <div class="spring-cleaning__info">
                    <h2 class="spring-cleaning__title title">Когда нужна генеральная уборка офиса?</h2>
                    <p>Если ежедневная уборка не придает офису опрятный вид, значит, в нем пора делать генеральную
                        уборку. Обычно ее нужно проводить хотя бы раз в 3 месяца, а также в следующих случаях:</p>
                    <img class="spring-cleaning__img" src="<?php bloginfo('template_url'); ?>/assets/img/spring-cleaning/mobail.jpg" alt="alt">
                    <div class="spring-cleaning__items">
                        <div class="spring-cleaning__item">
                            До переезда
                        </div>
                        <div class="spring-cleaning__item">
                            После ремонта
        ...
        <div class="difference__content">
            <div class="container">
                <div class="difference__inner">
                    <h2 class="difference__title title">Чем отличается генеральная уборка от обычной</h2>
                    <p class="difference__text text">
                        В зависимости от того как давно выполнялась уборка и от степени
                        загрязнённости квартиры к вам приедет команда клинеров или один сотрудник
                    </p>
                </div>
                <div class="difference__items">
                    <div class="difference__item">
                        <div class="difference__box">
                            от <strong>6400</strong> руб.
                        </div>
                        <h3 class="difference__subtitle">Командой клинеров</h3>
                        <ul class="difference__list">
                            <li class="difference__list-item">
                                От 2 до 6 клинеров
                            </li>
                            <li class="difference__list-item">
                                Уборкой руководит бригадир
                            </li>
                            <li class="difference__list-item">
                                В уборку включено всё (кроме доп. услуг)
                            </li>
                            <li class="difference__list-item">
                                Всё с собой, включая пылесос, стремянки, моющие средства и инвентарь
                            </li>
                        </ul>
                    </div>
                    <div class="difference__item">
                        <div class="difference__box">
                            от <strong>3890</strong> руб.
                        </div>
                        <h3 class="difference__subtitle">
                            Одним клинером
                        </h3>
                        <ul class="difference__list">
                            <li class="difference__list-item">
                            ...
                            <li class="difference__list-item">
                                Уборка по регламенту
                            </li>
                            <li class="difference__list-item">
                                Есть платные доп. опции
                            </li>
                            <li class="difference__list-item">
                                С собой моющие средства и инвентарь (кроме пылесоса)
                            </li>
                        </ul>
                    </div>
                </div>
